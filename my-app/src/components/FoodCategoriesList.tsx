    ...
    <>
      ...
      <div className='text-white font-bold text-center pb-10 text-2xl'>Food Categories</div>
          <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center gap-10'>
            {data.map((item) => (  
              <div key={item.idCategory} className="text-center p-10 rounded-xl  bg-gradient-to-r from-orange-500 to-orange-800 bg-opacity-10 transition ease-in-out delay-150 bg-white-100 hover:-translate-y-1 hover:scale-110 hover:bg-white-100 duration-300 ...">
