    ...
    <>
      ...
      <div className="w-full p-20 bg-black">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 pb-20 m-20">
          <div className="flex justify-center text-lg bg-orange-500 rounded-3xl p-6 text-black font-bold  border-orange-300 border-8" onClick={() => setShowModal(true)}>Surprise Me!</div>
          <div className="flex justify-center text-lg bg-orange-500 rounded-3xl p-6 text-black font-bold border-orange-300 border-8"><Link to={'/categories'}>View Categories</Link></div>
        </div>
      </div>
